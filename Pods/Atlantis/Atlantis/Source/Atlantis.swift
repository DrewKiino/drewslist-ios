...
public class Atlantis: NSObject {
  ...
  public class Logger: NSObject {
    ...
    @objc
    public func _verbose(_ arg: Any?) {
      logQueue.async {
        let logSettings = LogSettings(logLevel: .verbose, #function, #file, #line)
        if Logger.acceptableLogLevel(logSettings) {
          Logger.log(arg, logSettings)
        }
      }
    ...
    @objc
    public func _info(_ arg: Any?) {
      logQueue.async {
        let logSettings = LogSettings(logLevel: .info, #function, #file, #line)
        if Logger.acceptableLogLevel(logSettings) {
          Logger.log(arg, logSettings)
        }
      }
    ...
    @objc
    public func _warning(_ arg: Any?) {
      logQueue.async {
        let logSettings = LogSettings(logLevel: .warning, #function, #file, #line)
        if Logger.acceptableLogLevel(logSettings) {
          Logger.log(arg, logSettings)
        }
      }
    ...
    @objc
    public func _debug(_ arg: Any?) {
      logQueue.async {
        let logSettings = LogSettings(logLevel: .debug, #function, #file, #line)
        if Logger.acceptableLogLevel(logSettings) {
          Logger.log(arg, logSettings)
        }
      }
    ...
    @objc
    public func _error(_ arg: Any?) {
      logQueue.async {
        let logSettings = LogSettings(logLevel: .error, #function, #file, #line)
        if Logger.acceptableLogLevel(logSettings) {
          Logger.log(arg, logSettings)
        }
      }
