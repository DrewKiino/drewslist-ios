...
public class SearchSchoolController {
  ...
  public func searchSchool(query: String?) {
    guard let queryString = createQueryString(query) else { return }
  ...
  public class func clearCache() {
    ...
    SearchSchoolModel.sharedInstance().schools.removeAll(keepCapacity: true)
    SearchSchoolModel.sharedInstance().searchString = nil
  }
}
