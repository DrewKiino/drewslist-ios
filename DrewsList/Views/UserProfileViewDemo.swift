...
//controller.view = self
  ...
  public func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
    let cell = collectionView.dequeueReusableCellWithReuseIdentifier("wishListCell", forIndexPath: indexPath) as? BookCell
//    if (collectionView.tag == 0){
//      let cell = collectionView.dequeueReusableCellWithReuseIdentifier("salesListCell", forIndexPath: indexPath) as! CollectionViewCell
//    } else {
//      let cell = collectionView.dequeueReusableCellWithReuseIdentifier("wishListCell", forIndexPath: indexPath) as! CollectionViewCell
//    }
